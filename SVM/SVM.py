# -*- coding: utf-8 -*-
"""
Created on Mon Oct 15 21:57:36 2018
...
#n_classes = 2
#y1 = np_utils.to_categorical(y1, n_classes)


X_train, X_test, y_train, y_test = train_test_split( X1, y1, test_size=0.3, random_state=1 )

#a = y_test[0:,][0:, 1]
#To count the anomalous data in y_test - 
#collections.Counter(a)
a = np.count_nonzero(y_test)
print("Number of anomaly in y_test: ", a)

clf = SVC(C=150, kernel='linear')
